...
## REACTS: 🖐️😮🖐️ The Fish "shell" is not a shell and is cringe to use.
 - [https://www.youtube.com/watch?v=8AQobpqySAU](https://www.youtube.com/watch?v=8AQobpqySAU)
 - RSS feed: https://www.youtube.com/feeds/videos.xml?channel_id=UC2eYFnH61tmytImy1mTYvhA
 - date published: 2021-03-22 00:00:00+00:00

I talk about bash vs. shell here (Bash is Bloated!): https://www.youtube.com/watch?v=UnbmwxYi18I
Learn about zsh (zsh: Syntax Highlighting, vi-mode, Autocomplete, more
), which you should be using instead of something soy-tier like fish: https://www.youtube.com/watch?v=eLEo4OQ-cuQ
