...
## Seeking (Non-)Soydev for Work out of Laziness
 - [https://www.youtube.com/watch?v=uUldo_jJq7A](https://www.youtube.com/watch?v=uUldo_jJq7A)
 - RSS feed: https://www.youtube.com/feeds/videos.xml?channel_id=UC2eYFnH61tmytImy1mTYvhA
 - date published: 2021-04-28 00:00:00+00:00

I don't think I mentioned it in the recording, but I'd like compatibility with Coinpayments, so that people can also use Bitcoin or Monero instead of dollars and other fiat currencies if they want.

API info:
- Stripe API: https://stripe.com/docs/api
- Lulu API: https://api.lulu.com/docs/
- Coinpayments API: https://merchants.coinpayments.net/integration-guide/
